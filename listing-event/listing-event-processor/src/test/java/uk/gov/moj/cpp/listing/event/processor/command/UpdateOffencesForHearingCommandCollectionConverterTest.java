...
public class UpdateOffencesForHearingCommandCollectionConverterTest {

    private UpdateOffencesForHearingCommandCollectionConverter  updateDefendantsForHearingCommandCollectionConverter = new UpdateOffencesForHearingCommandCollectionConverter();
    ...
    public void convertFromDefendantsToBeUpdatedEventToListOfUpdateDefendantsForHearingCommands() throws Exception {
        //given
        OffencesToBeUpdated offencesToBeUpdated = eventBuilder.buildOffencesToBeUpdated();

        //when
        List<UpdateOffencesForHearingCommand> actualList = updateDefendantsForHearingCommandCollectionConverter.convert(offencesToBeUpdated);
