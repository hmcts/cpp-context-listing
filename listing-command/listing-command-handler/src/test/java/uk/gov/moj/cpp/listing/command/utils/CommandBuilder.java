...
public class CommandBuilder {
    ...
    public HearingListingNeeds buildCommandHearingWithCommittingCourt() {
        JsonObject hearingJsonObject = givenPayload("/test-data/listing.commands.hearing-with-committing-court.json");
        return jsonObjectToObjectConverter.convert(hearingJsonObject, HearingListingNeeds.class);
    }

    public HearingListingNeeds buildCommandHearingWithWelshAddress() {
        JsonObject hearingJsonObject = givenPayload("/test-data/listing.commands.hearing-with-welsh-address.json");
        return jsonObjectToObjectConverter.convert(hearingJsonObject, HearingListingNeeds.class);
    }

    public HearingListingNeeds buildCommandHearingWithLaaReference() {
        JsonObject hearingJsonObject = givenPayload("/test-data/listing.commands.hearing-with-laa-reference.json");
        return jsonObjectToObjectConverter.convert(hearingJsonObject, HearingListingNeeds.class);
    }
