...
public class ReportingRestrictionConverterTest {
    ...
    public void shouldConvertCourtsToDomainObject() {
        ...
        final ReportingRestriction reportingRestrictionDomain = uk.gov.moj.cpp.listing.command.utils.ReportingRestrictionConverter.courtsToDomain(reportingRestrictionCourts);
    ...
    public void shouldConvertEventsToDomainObject() {
        ...
        final ReportingRestriction reportingRestrictionDomain = uk.gov.moj.cpp.listing.command.utils.ReportingRestrictionConverter.eventsToDomain(reportingRestrictionEvents);
    ...
    public void shouldConvertDomainToEventsObject() {
        ...
        final uk.gov.justice.listing.events.ReportingRestriction reportingRestrictionEvents = uk.gov.moj.cpp.listing.command.utils.ReportingRestrictionConverter.domainToEvents(reportingRestrictionDomain);
    ...
    public void shouldConvertCourtsToEventsObject() {
        ...
        final uk.gov.justice.listing.events.ReportingRestriction reportingRestrictionEvents = uk.gov.moj.cpp.listing.command.utils.ReportingRestrictionConverter.courtsToEvents(reportingRestrictionCourts);
