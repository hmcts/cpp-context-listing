...
@Provider
public class ChangeCourtRoomForMultidayExceptionMapper implements ExceptionMapper<ChangeCourtRoomForMultidayException> {

    @Inject
    Logger logger;

    @Override
    public Response toResponse(final ChangeCourtRoomForMultidayException exception) {
        logger.debug("change-court-room-for-multiday-hearing rejected", exception);
