...
class MoveHearingDateExceptionMapperTest {

    private MoveHearingDateExceptionMapper mapper;

    @BeforeEach
    void setUp() {
        mapper = new MoveHearingDateExceptionMapper();
        mapper.logger = LoggerFactory.getLogger(MoveHearingDateExceptionMapperTest.class);
    }
    ...
    void futureDate_returns422_withErrorCodeAndMessage() {
        ...
        final Response response = mapper.toResponse(new MoveHearingDateException(422, body, "rejected"));
    ...
    void noSession_propagates404_withMessage() {
        ...
        final Response response = mapper.toResponse(new MoveHearingDateException(404, body, "not found"));
    ...
    void nullBody_fallsBackToExceptionMessage() {
        final Response response = mapper.toResponse(new MoveHearingDateException(500, null, "unexpected failure"));
