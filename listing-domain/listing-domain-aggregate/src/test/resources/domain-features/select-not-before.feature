Feature: Select 'not before' start time for the hearing
  ...
  Scenario: An unallocated hearing has been listed and the start time has been assigned.
    ...
    When selectNotBefore to a uk.gov.moj.cpp.listing.domain.aggregate.HearingAggregate using selected-true
  ...
  Scenario: An unallocated hearing has been listed, the start time has been assigned and 'not before' selected to true.
    ...
    When selectNotBefore to a uk.gov.moj.cpp.listing.domain.aggregate.HearingAggregate using selected-false
  ...
  Scenario: A request to select 'not before' for a hearing that has not been listed does not result in any change
