...
public class JsonHelperTest {
    ...
    public void shouldGetStringFromArray() {
        ...
        final String caseMarker = JsonHelper.getStringFromArray(jsonObject, "caseMarkers", 0, "caseMarker");
    ...
    public void shouldReturnEmptyStringIfNotFoundInArray() {
        ...
        final String caseMarker = JsonHelper.getStringFromArray(jsonObject, "caseMarkers", 1, "caseMarker");
    ...
    public void shouldGetZonedDateTime() throws Exception {
        ...
        final Optional<ZonedDateTime> actual = JsonHelper.getZonedDateTime(jsonObject, "dateTimeCreated");
    ...
    public void shouldGetIntAsString() throws Exception {
        ...
        final String result = JsonHelper.getIntAsString(jsonObject, "version");
    ...
    public void shouldGetEmptyStringForGetIntAsString() throws Exception {
        ...
        final String result = JsonHelper.getIntAsString(jsonObject, "sd");
