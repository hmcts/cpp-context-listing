...
@Event("listing.events.allocated-hearing-updated-for-listing")
@JsonInclude(value = JsonInclude.Include.NON_NULL)
@SuppressWarnings("squid:S00107")
public class AllocatedHearingUpdatedForListing extends HearingEvent {
    ...
    public AllocatedHearingUpdatedForListing(@JsonProperty(value = "hearingId") final String hearingId,
