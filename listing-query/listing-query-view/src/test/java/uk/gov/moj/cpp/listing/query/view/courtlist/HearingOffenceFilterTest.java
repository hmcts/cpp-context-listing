...
public class HearingOffenceFilterTest {
    ...
    @Test
    public void shouldKeepHearingWhenDefendantsArrayIsEmpty() {
        ...
        assertThat(remainingHearings.getJsonObject(0).getString("startTime"), is("no-defendants-listed"));
    }
    ...
    public void shouldReturnPayloadUnchangedWhenCourtListsKeyIsMissing() {
        ...
        assertThat(HearingOffenceFilter.removeHearingsWithDefendantMissingOffences(payload), is(payload));
    }
