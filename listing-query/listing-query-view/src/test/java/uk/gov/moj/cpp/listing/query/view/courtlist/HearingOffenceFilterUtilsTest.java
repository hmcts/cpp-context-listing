...
public class HearingOffenceFilterUtilsTest {
    ...
    public void shouldRemoveHearingWhenADefendantHasNoOffences() {
        ...
        final JsonObject result = HearingOffenceFilterUtils.removeDefendantsAndHearingsMissingOffences(payload);
    ...
    public void shouldReturnPayloadUnchangedWhenCourtListsKeyIsMissing() {
        ...
        assertThat(HearingOffenceFilterUtils.removeDefendantsAndHearingsMissingOffences(payload), is(payload));
    }
    ...
    public void privateConstructorShouldThrowIllegalStateException() {
        assertThrows(InvocationTargetException.class, () -> {
            final Constructor<HearingOffenceFilterUtils> constructor = HearingOffenceFilterUtils.class.getDeclaredConstructor();
