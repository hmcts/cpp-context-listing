...
public enum ApplicationTypeTest {
    ...
    ApplicationTypeTest(final String applicationTypeCode, final String title) {
        this.applicationTypeCode = applicationTypeCode;
        this.title = title;
    }

    public static String getApplicationTypeTitle(final String applicationTypeCode) {
        final ApplicationTypeTest[] applicationTypes = ApplicationTypeTest.values();
        for (final ApplicationTypeTest applicationType : applicationTypes) {
