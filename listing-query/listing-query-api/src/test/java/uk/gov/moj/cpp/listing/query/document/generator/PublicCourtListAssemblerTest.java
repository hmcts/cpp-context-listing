...
public class PublicCourtListAssemblerTest {
    ...
    public void shouldBuildDataForPublicCourtList() throws Exception {
        ...
        JsonObject publicListData = publicListService.assemble(buildRequestEnvelope(), COURT_CENTRE_ID.toString(), COURT_ROOM_1_ID.toString(), CourtListType.PUBLIC).get();
    ...
    public void shouldBuildDataForPublicCourtListWhenJudiciaryIsEmpty() throws Exception {
        ...
        JsonObject publicListData = publicListService.assemble(buildRequestEnvelopeWithNoJudiciary(), COURT_CENTRE_ID.toString(), COURT_ROOM_1_ID.toString(), CourtListType.PUBLIC).get();
    ...
    public void shouldBuildDataForWelshPublicCourtList() throws Exception {
        ...
        JsonObject publicListData = publicListService.assemble(envelope, COURT_CENTRE_ID.toString(), COURT_ROOM_1_ID.toString(), CourtListType.PUBLIC).get();
    ...
    private void assertWelshPublicCourtListPayload(JsonObject publicListData) {
        assertThat(publicListData.getString("listType"), is(CourtListType.PUBLIC.toString().toLowerCase().concat(WELSH)));
