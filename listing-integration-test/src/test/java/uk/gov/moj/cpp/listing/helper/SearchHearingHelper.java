...
public class SearchHearingHelper {
    ...
    public static String pollForHearingWithJmsDelay(final String courtCentreId, final boolean allocated, final String userId, final Matcher[] matchers) {
        ...
        return RestPollerHelper.pollWithJmsDelay(RequestParamsBuilder.requestParams(searchHearingUrl, SearchHearingHelper.MEDIA_TYPE_SEARCH_HEARINGS_JSON).withHeader(HeaderConstants.USER_ID, userId).build())
                .until(
