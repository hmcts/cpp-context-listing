...
public class UpdateCaseMarkersSteps extends AbstractIT {
    ...
    public void whenCaseMarkerUpdatedPublicEventIsPublished() {
        final JsonObject caseMarkersUpdated = getCaseMarkerUpdate(caseId, hearingData.getId());
    ...
    public JsonObject getCaseMarkerUpdate(final UUID caseId, final UUID hearingId) {
        return Json.createObjectBuilder()
                .add("prosecutionCaseId", caseId.toString())
                .add("hearingId", hearingId.toString())
                .add("caseMarkers", buildCaseMarkers())
                .build();
    }

    private JsonArray buildCaseMarkers() {
        return Json.createArrayBuilder()
                .add(Json.createObjectBuilder()
                        .add("id", caseMarkerData.getId().toString())
                        .add("markerTypeid", caseMarkerData.getCaseMarkerTypeId().toString())
                        .add("markerTypeCode", caseMarkerData.getCaseMarkerCode())
                        .add("markerTypeDescription", caseMarkerData.getCaseMarkerDescription()))
                .build();
    }

    private void publishCaseMarkersUpdated(final JsonObject caseMarkersUpdated) {
