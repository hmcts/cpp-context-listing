...
public class UpdatedOffenceDataWithCustodyTimeLimit {
    ...
    private UpdatedOffenceDataWithCustodyTimeLimit(final UUID offenceId, final String offenceCode,
                                                   ...
                                                   final String legislation, final String legislationWelsh,final Optional<CustodyTimeLimit> custodyTimeLimit) {
    ...
    public static final UpdatedOffenceDataWithCustodyTimeLimit updateOffenceData(OffenceData offenceData) {
        return builder()
    ...
    private static class Builder {
        ...
        public UpdatedOffenceDataWithCustodyTimeLimit build() {
            return new UpdatedOffenceDataWithCustodyTimeLimit(offenceId, offenceCode, startDate, endDate,
                    statementOfOffenceTitle, statementOfOffenceTitleWelsh, offenceWording,
                    legislation, legislationWelsh, custodyTimeLimit);
        }
    }
}
